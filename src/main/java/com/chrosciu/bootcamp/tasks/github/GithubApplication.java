...
public class GithubApplication {
    ...
    @SneakyThrows
    private void run() {
//        Flux<Repository> repositories = githubClient.getUserRepositories("bartmj");
//        repositories.subscribe(r -> log.info("{}", r));
//
//        Flux<Branch> branches = githubClient.getUserRepositoryBranches("bartmj", "newsapi");
//        branches.subscribe(b -> log.info("{}", b));
//
//        Flux<String> userBranchesNames = githubClient.getAllUserBranchesNames("bartmj");
//        userBranchesNames.subscribe(r -> log.info("{}", r));

        InputStream input = System.in;
        Flux<String> inputs = InputUtils.toFlux(input);

        Flux<Repository> userRepositories = githubClient.getUsersRepositories(inputs);

        userRepositories.subscribe(r -> log.info("{}", r));
    }
